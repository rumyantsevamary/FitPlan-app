...
var CHANGE_MONTH = exports.CHANGE_MONTH = 'CHANGE_MONTH';
var GET_PLANNED_EVENTS_REQUEST = exports.GET_PLANNED_EVENTS_REQUEST = 'GET_PLANNED_EVENTS_REQUEST';
var GET_PLANNED_EVENTS_SUCCESS = exports.GET_PLANNED_EVENTS_SUCCESS = 'GET_PLANNED_EVENTS_SUCCESS';
var GET_PLANNED_EVENTS_FAIL = exports.GET_PLANNED_EVENTS_FAIL = 'GET_PLANNED_EVENTS_FAIL';
var OPEN_DAY_DETAILS = exports.OPEN_DAY_DETAILS = 'OPEN_DAY_DETAILS';

/***/ }),

/***/ "./src/constants/MainMenu.js":
/*!***********************************!*\
  !*** ./src/constants/MainMenu.js ***!
  \***********************************/
/*! no static exports found */
...
var GET_MAIN_MENU_REQUEST = exports.GET_MAIN_MENU_REQUEST = 'GET_MAIN_MENU_REQUEST';
var GET_MAIN_MENU_SUCCESS = exports.GET_MAIN_MENU_SUCCESS = 'GET_MAIN_MENU_SUCCESS';
var GET_MAIN_MENU_FAIL = exports.GET_MAIN_MENU_FAIL = 'GET_MAIN_MENU_FAIL';
...
var GET_CURRENT_USER_REQUEST = exports.GET_CURRENT_USER_REQUEST = 'GET_CURRENT_USER_REQUEST';
var GET_CURRENT_USER_SUCCESS = exports.GET_CURRENT_USER_SUCCESS = 'GET_CURRENT_USER_SUCCESS';
var GET_CURRENT_USER_FAIL = exports.GET_CURRENT_USER_FAIL = 'GET_CURRENT_USER_FAIL';
...
var _App = __webpack_require__(/*! ./components/app/App.tsx */ "./src/components/app/App.tsx");
...
exports.default = calendarState;

var _Calendar = __webpack_require__(/*! ../constants/Calendar */ "./src/constants/Calendar.js");
...
function calendarState() {
    ...
    switch (action.type) {
        case _Calendar.CHANGE_MONTH:
            return Object.assign({}, state, {
                month: action.playload.month,
                year: action.playload.year
            });

        case _Calendar.GET_PLANNED_EVENTS_REQUEST:
            return Object.assign({}, state, {
                fetching: true
            });

        case _Calendar.GET_PLANNED_EVENTS_SUCCESS:
            return Object.assign({}, state, {
                fetching: false, plannedEvents: action.playload
            });

        case _Calendar.GET_PLANNED_EVENTS_FAIL:
            console.log(action.playload);
            return state;

        case _Calendar.OPEN_DAY_DETAILS:
            return Object.assign({}, state, {
...
var _mainMenu = __webpack_require__(/*! ./mainMenu */ "./src/reducers/mainMenu.js");

var _mainMenu2 = _interopRequireDefault(_mainMenu);

var _calendar = __webpack_require__(/*! ./calendar */ "./src/reducers/calendar.js");
...
var _MainMenu = __webpack_require__(/*! ../constants/MainMenu */ "./src/constants/MainMenu.js");
...
function mainMenuState() {
    ...
    switch (action.type) {
        case _MainMenu.GET_MAIN_MENU_REQUEST:
            return Object.assign({}, state, {
                fetching: true
            });

        case _MainMenu.GET_MAIN_MENU_SUCCESS:
            return Object.assign({}, state, {
                fetching: false, menuItems: action.playload.menuItems, userRole: action.playload.userRole
            });

        case _MainMenu.GET_MAIN_MENU_FAIL:
            console.log(action.playload);
            return state;

        case _MainMenu.SET_ACTIVE_CONTENT:
            return Object.assign({}, state, {
...
function userstate() {
    ...
    switch (action.type) {
        case _User.GET_CURRENT_USER_REQUEST:
            return Object.assign({}, state, {
                fetching: true
            });
        case _User.GET_CURRENT_USER_SUCCESS:
            return Object.assign({}, state, {
                fetching: false, cUser: action.playload
            });
        case _User.GET_CURRENT_USER_FAIL:
            console.log(action.playload);
            return state;
        default:
            return state;
